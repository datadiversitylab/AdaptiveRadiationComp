...
extracted_values <- extract(habitat_lvl2, ranges)
...
extracted_values <- lapply(ranges, function(x) extract(habitat_lvl2, x))
...
extracted_values <- extract(habitat_lvl2, occur_buffers, fun = mean, na.rm = TRUE)
